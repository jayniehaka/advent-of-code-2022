...
def do_the_move_part_2(move_info, stack_list):
    numer_of_crates = move_info[0]
    source_stack = move_info[1]
    target_stack = move_info[2]
    
    source_crates = stack_list[source_stack - 1][:numer_of_crates]
    stack_list[source_stack - 1] =  stack_list[source_stack - 1][numer_of_crates:]

    stack_list[target_stack - 1] = source_crates +  stack_list[target_stack - 1] 
...
for move in moves:
    move_info = get_move_info(move_str = move)
    moved_crates = do_the_move_part_2(move_info, moved_crates)
exit
